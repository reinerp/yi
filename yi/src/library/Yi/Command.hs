...
configureExit :: Either IOException ExitCode -> YiM ()
...
buildRun :: String -> [String] -> (Either IOException ExitCode -> YiM x) -> YiM ()
...
cabalRun :: String -> (Either IOException ExitCode -> YiM x) -> CommandArguments -> YiM ()
